...
import { signOutAccount, signInWithGithub, signInWithGoogle } from "../firebase/auth";
                            ...
                            <div className="w-10/12 mx-auto">
                              ...
                              <div className="mt-8 flex flex-col space-y-2">
                                <button className='btn flex w-full p-2 rounded-lg h-11 items-center justify-center space-x-2 bg-white font-semibold text-black hover:bg-white/80' onClick={handleContinueWithGoogle}>
                                  <svg stroke="currentColor" fill="currentColor" stroke-width="0" version="1.1" x="0px" y="0px" viewBox="0 0 48 48" enable-background="new 0 0 48 48" class="text-xl" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill="#FFC107" d="M43.611,20.083H42V20H24v8h11.303c-1.649,4.657-6.08,8-11.303,8c-6.627,0-12-5.373-12-12
